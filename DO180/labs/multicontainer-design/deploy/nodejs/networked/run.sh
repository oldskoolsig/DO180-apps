...
sudo podman run -d --name mysql -e MYSQL_DATABASE=items -e MYSQL_USER=user1 -e MYSQL_PASSWORD=mypa55 \
	-e MYSQL_ROOT_PASSWORD=r00tpa55 -v ${PWD}/work/data:/var/lib/mysql/data \
